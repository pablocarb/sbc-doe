...
def makeDoeScript(fact, outfile, size, seed=None, starts=1040, executable=False, makeTable=False, makeFullFactorial=False, onlyCategorical=True):
    ...
    doe.append('//  B. Another type of experiment, i.e., factorial, definitive screening, response surface, mixture, etc: save the factors to a JMP table and load them into the new experiment')
    doe.append( 'DOE(' )
